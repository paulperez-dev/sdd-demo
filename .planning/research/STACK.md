...
**Domain:** Local desktop URL shortener — Flutter desktop app with embedded Dart HTTP server
**Researched:** 2026-03-26
**Confidence:** HIGH (all versions verified against pub.dev; Flutter/Dart versions verified against official release notes)
...
**Embedding the server in the same process as Flutter:**
...
**Running the server in a background Isolate (if UI jank occurs):**
...
---
*Stack research for: Local desktop URL shortener — Dart/Flutter*
*Researched: 2026-03-26*
